...
class Client(Timestamped):
    ...
    state = models.CharField("estado", max_length=2, blank=True, default="RJ")
    postal_code = models.CharField("CEP", max_length=10, blank=True)
    official_street_code = models.CharField("código oficial do logradouro", max_length=30, blank=True, db_index=True)
    address_validated_at = models.DateTimeField("endereço validado em", null=True, blank=True)
